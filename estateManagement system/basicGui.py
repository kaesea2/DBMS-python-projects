...
class BasicGui(Tk):
    def __init__(self):
        super().__init__()
        # containers
        self.Thoroughfare = ManagerGui.Thoroughfares
        self.Property = ManagerGui.Properties
        self.Household = ManagerGui.Households
        self.Receipt = []

        # set the windows components
        self.geometry('640x430')
        self.title('BASIC USER WINDOW')
        self.configure(bg='#888')

        # frames
        self.menuFrame = Frame(self, bg='#888', width=640, height=100, pady=20)
        self.showFrame = Frame(self, bg="#fff", width=640, height=300)
        self.footerFrame = Frame(self, bg='#888', width=640, height=30, pady=20)
        ...
        # menu functions
        self.thoroughfareFunctions = ['CREATE THOROUGHFARE', 'VIEW THOROUGHFARE', 'UPDATE THOROUGHFARE']
        self.propertyFunctions = ['CREATE PROPERTY', 'VIEW PROPERTY', 'UPDATE PROPERTY']
        self.householdFunctions = ['CREATE HOUSEHOLD', 'VIEW HOUSEHOLD', 'UPDATE HOUSEHOLD']
        ...
        self.thoroughfareOptions.grid(row=0, column=0)
        self.propertyOptions.grid(row=0, column=1)
        self.householdOptions.grid(row=0, column=2)
...
# receipt functions
    ...
    def create_receipt(self):
        ...
        if receipt not in self.Receipt:
            ...
            ManagerGui.Receipts.append(receipt)
    ...
    def viewReceiptClicked(self):
        ...
        self.view_receipt_list.configure(height=8, width=30)
